...
export class LoaderService {
  ...
  public loaderOverlay: BehaviorSubject<string> = new BehaviorSubject<string>(
    'loader-overlay hidden'
  );
  public confimationsNeed: BehaviorSubject<number> =
    new BehaviorSubject<number>(0);
  public confimationPerc: BehaviorSubject<number> = new BehaviorSubject<number>(
    0
  );
